...
CREATE TABLE base (
        ...
        name TEXT NOT NULL, -- full name, e.g. "Super Mario Bros."; must not include [square brackets]
...
CREATE TABLE rhack (
        ...
        name TEXT NOT NULL, -- must not include [square brackets]
        author TEXT NOT NULL,
        type TEXT, -- e.g. 'English translation' or 'Randomizer'; put NULL when original hack
        released TEXT, -- 'YYYY-MM-DD'; if e.g. only year and month is available do 'YYYY-MM'
        version TEXT NOT NULL, -- e.g. '1.0' or '0.5.5'; must only include numbers and dots
        retro_achievements TEXT NOT NULL, -- 'yes' or 'no'
        url TEXT, -- direct download link; always prefer the latest patch provided by github.com/RetroAchievements/RAPatches
        archive_path TEXT, -- path of the patch file inside the archive, e.g. 'patches/v1.bps'
        installed_version TEXT, -- this gets filled in if the user has this hack already installed
...
-- Super Mario 64
('3ce60709', 'Super Mario 64 (U)', 'Randomizer', '1.1.2', 'Arthurtilly', 'N/A', 'yes', 'https://github.com/RetroAchievements/RAPatches/raw/main/N64/Hacks/Super%20Mario%2064/10509-SM64-Randomizer.zip', 'SM64 - Randomizer (v1.1.2) (Arthurtilly).bps', 'Randomizer for SM64'),
...
-- Tomato Adventure
('e37ca939', 'Tomato Adventure (J)', 'English translation', '1.1.1', 'Unknown W. Brackets', '2021-06-17', 'yes', 'https://github.com/RetroAchievements/RAPatches/raw/main/GBA/Translation/English/9802-TomatoAdv-EnglishTranslation.zip', 'Tomato Adventure (Japan) (En) (v1.1.1) (Unknown W. Brackets).bps', 'English translation of Tomato Adventure (J)')
;
