...
post_update() {
  ...
  choice=$(rd_zenity --title "RetroDECK Update - Backup Userdata 🗄️" --info --no-wrap --ok-label="No Backup 🟥" --extra-button="Core Backup 🟠" --extra-button="Custom Backup  🟡" --extra-button="Complete Backup 🟢" \
