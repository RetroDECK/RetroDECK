...
convert_cfg_to_json() {
  ...
  declare -A PRESET_NESTING_MAP=(
    ...
    ["borders.snes"]="retroarch_cores.snes9x_libretro"
    ...
    ["widescreen.snes"]="retroarch_cores.snes9x_libretro"
    ...
    ["rewind.snes"]="retroarch_cores.snes9x_libretro"
    ...
    ["abxy_button_swap.snes"]="retroarch_cores.snes9x_libretro"
  )
