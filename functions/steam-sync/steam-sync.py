...
"switch": "flatpak run --command=/var/data/ponzu/Yuzu/yuzu-qt net.retrodeck.retrodeck -f -g",
"n3ds": "flatpak run --command=/var/data/ponzu/Citra/citra-qt net.retrodeck.retrodeck",
